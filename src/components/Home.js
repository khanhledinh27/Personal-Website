      ...
      <div className="container mx-auto flex px-10 pb-20 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 flex flex-col  md:items-start md:text-left mb-16 md:mb-0  items-center text-center">
            ...
            <div className="flex justify-center mt-5 mb-5">
              ...
              <a href="projects" class="relative ml-4 inline-flex py-2 px-2 md:py-2 md:px-6 overflow-hidden font-medium text-black bg-white border border-black  rounded shadow-inner group">
